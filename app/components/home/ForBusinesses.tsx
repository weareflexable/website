    ...
    <div className="md:max-w-[1200px] mx-auto py-20">
      <div className="my-10 mx-6 sm:mx-0">
        <h1 className="text-white text-6xl relative">
          {title}
          <span className="absolute -bottom-3 left-0 w-1/2 h-[3px] bg-gradient-to-r from-accent to-primary"></span>
        </h1>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 max-w-[1136px] mx-auto mt-20">
        {data.map((card, index) => (
          <div className="flex items-center" key={index}>
            ...
            />
            {index < data.length - 1 && (
              <div className="hidden md:flex items-center justify-center w-32 mb-40">
                <Image
