...
const Partnerwithus = () => {
  return (
    <>
      <div className="text-center text-6xl font-bold italic mt-9 pt-10">
      ...
      <div className="max-w-[1240px] mx-auto mt-10 pt-10 grid md:grid-cols-2">
        <div className="flex flex-col text-[#8109f8] font-bold  mx-5 ">
          ...
          <p className="text-xl text-justify">
            ...
            operate. Until now, revenue was limited solely to the services they
        ...
        <img
          className="w-[1000px] mx-5  rounded-full "
          src="/partner.gif"
          alt="/"
        />
      </div>
      <div className="mt-5 pt-5 text-[#8109f8] font-bold text-xl text-center">
        ...
        <br />
        <p>
          “Flexable has created passive income for my venue where I didn't know
          it existed before” <br></br> - You, the venue owner, shortly after
          partnering with us
        </p>
        <br />
        <p>
